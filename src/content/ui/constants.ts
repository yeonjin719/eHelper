...
export const UI_HIDE_DONE_LECTURES_KEY = `${UI_STORAGE_PREFIX}:hideDoneLectures`;
export const UI_HIDE_DONE_ASSIGNMENTS_KEY = `${UI_STORAGE_PREFIX}:hideDoneAssignments`;
export const UI_HIDE_RESOURCES_KEY = `${UI_STORAGE_PREFIX}:hideResources`;
export const UI_HIDE_NOTICES_KEY = `${UI_STORAGE_PREFIX}:hideNotices`;
